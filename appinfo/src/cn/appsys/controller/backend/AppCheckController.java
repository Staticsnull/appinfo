...
public class AppCheckController {
	...
	public List<AppCategory> getAppCategoryList(@RequestParam String pid){
		logger.info("getAppCategoryList==>");
	...
	public String check(@RequestParam(value="aid",required=false) String appId,Model model,
						@RequestParam(value="vid",required=false) String versionId){
		AppInfo appInfo = null;
		AppVersion appVersion = null;
		try {
			appInfo = appService.getAppInfoById(Integer.parseInt(appId));
